...
base = etree.parse(open("C:/project/globocan2022_graph/map/map_temp.svg" ))
root = base.getroot()
legend_nb= 0
...
g_dis[6][0][0].text = "© IARC/WHO 2024. All rights reserved"
...
base.write("C:/project/globocan2022_graph/map/map_temp_test.svg", pretty_print=False)
