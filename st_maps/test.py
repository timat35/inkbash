...
base = etree.parse(open('./test.svg'))
root = base.getroot()
legend_nb= 0
...
dis = etree.parse(open('./disclaimer.svg'))
...
g_dis[0][0].text = "Data source: " + "thisis"
g_dis[0][1].text = "Map production: " + "atest"
g_dis[0].remove(g_dis[0][3])

g_dis[1][1][0].text = "© WHO 2018. All rights reserved"
root.append(g_dis)
...
base.write('./out.svg', pretty_print=False)
