...
base = etree.parse(open("C:/project/globocan_paperboy/_figs/06_oesophagus/map/map_asr_oesophagus_both_incidence.svg"))
root = base.getroot()
legend_nb= 0
...
g_dis[0][0].text = "Data source: " + "source"
g_dis[0][1].text = "Map production: " + "Mat"
